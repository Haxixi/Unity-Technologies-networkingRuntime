...
namespace UnityEngine.Networking
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        {
            if (LogFilter.logDebug) { Debug.Log("NetworkManager OnMatchCreate " + matchInfo); }
        ...
        {
            if (LogFilter.logDebug) { Debug.Log("NetworkManager OnMatchList "); }
            matches = matchList.matches;
        }

        public void OnMatchJoined(JoinMatchResponse matchInfo)
        {
            if (LogFilter.logDebug) { Debug.Log("NetworkManager OnMatchJoined "); }
            if (matchInfo.success)
            {
                Utility.SetAccessTokenForNetwork(matchInfo.networkId, new NetworkAccessToken(matchInfo.accessTokenString));
